...
function ActionImage(props){
   ...
   async function imageAction(action){
           ...
           try{
            if(action==="add"){
                ...
                await fetch(properties.remoteServer+"/admin/api/variants/"+variantId+"/images",{
                    method:"POST",
                    body:formData,
                    credentials: "include",
                    headers: {
                    ...
                    const resultContainer=document.getElementById("image-result-display");
                ...
                await fetch(properties.remoteServer+"/admin/api/images/"+imageId,{
                    method:"PUT",
            ...
            if(action==="Add"){
                return(
                    <div className="general-container">
                        <div className="general-heading">Add Image</div>

                        <div style={{paddingTop: 10}}>
                            <div className="general-input-name">Image Name</div>
                        ...
                        <div className="container-align-center">
                            <input type={"button"} className="general-btn-style"  id="add-image-btn" onClick={()=>{imageAction("add")}}  value="Add"/>
                        </div>
                ...
                return(
                    <div className="general-container">
                        <div className="general-heading">Edit Image</div>
                        ...
                        <div className="container-align-center">
                            <input type={"button"} className="general-btn-style"  id="add-image-btn" onClick={()=>{imageAction("edit")}}  value="Edit"/>
                        </div>
   ...
   return(
      <>
        <h3 style={{textAlign:"center",padding:20,color:"maroon"}}>{action} images for variant {variant.name}</h3>
        <div className="container-align-center">
            <div className="result-container" id="image-result-display"><h6 style={{textAlign:"center"}} id="image-result-content"> </h6></div>
        </div>
        <div className="container-align-center">
            {renderForm()}
        </div>
